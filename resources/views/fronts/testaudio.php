...
<div class="container music-container" id="music-container">
     @if ($audio->popup_status == 1)
  <audio src="{{asset('uploads/product/audio/attachment/'.$audio->productAds->media_file)}}" id="audioads"></audio>
  @endif
...
<div class="movies-thumb-slider bg-section-2 py-3 container" style="display:none;margin-top:4rem;  @if($audio->product->category_id == 5) {{ 'display:none' }} @endif">
...
<style>
 ...
 @if ($audio->popup_status == 1)
    <script>
        const adsAfter = {{$audio->productAds->after_time}}
...
<!--<script src="https://firstmoneyfinance.com/suno-kahaniya/assets-front/js/scriptmedia.js"></script>-->
@endsection
@endsection
