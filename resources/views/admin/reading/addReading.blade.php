...
<style>
   .dataTables_length{
    ...
    <section class="content">
        ...
        <form method="post" action="{{ route('saveSingleChapter') }}" enctype="multipart/form-data" id="subCategory">
          @csrf
          <div class="card-body">
        ...
        <input type="hidden" name="productMediaId" value="{{$proMedia}}">
              ...
              <div class="form-group">
                ...
                <textarea name="description" class="form-control" id="matter1">{{ $media->description ?? ''}}</textarea>
              </div>
