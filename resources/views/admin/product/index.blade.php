                ...
                <table class="table table-striped" id="example1">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td> @if(!empty($category->category->name )) {{$category->category->name}} @else "" @endif</td>
                      ...
                      <a class="btn1 " href="{{ route('product.get-media',$category->id) }}"><i class="fas fa-paperclip pl-1"></i></a> 

                        <a href="{{ route('productEdit',$category->id) }}" class="btn1" title="Edit"><i class="fa fa-edit"></i></a>
                        <a href="{{ route('removeProduct',$category->id) }}" class="btn1" style="color:red" title="Delete"><i class="fa fa-trash"></i></a>
